        ...
        >
          ...
          >
            ...
            >
              <MarkerCluster>
                <Marker
                  v-for="(location, i) in GPSData"
                  :options="{
                    position: { lat: location.lat, lng: location.lng },
                    title: `${GPSData[i].VIN_ID}`,
                    icon: url,
                  }"
                  :key="i"
                />
...
/*PermissionsCarlist.value = {
  car_list: [
    { VIN_ID: "ZWE211-0019764   " },
    { VIN_ID: "ZWE211-0019760   " },
    { VIN_ID: "ZWE211-0019761   " },
    { VIN_ID: "ZWE211-0019762   " },
    { VIN_ID: "ZWE211-0019763   " },
    { VIN_ID: "ZWE211-0019765   " },
    { VIN_ID: "ZWE211-0019766   " },
    { VIN_ID: "ZWE211-0019767   " },
    { VIN_ID: "ZWE211-0019768   " },
    { VIN_ID: "ZWE211-0019769   " },
  ],
};*/
//===================================================================//
//獲取GPS資料
