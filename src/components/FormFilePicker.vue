  ...
  <div class="relative flex items-stretch justify-start">
    <label class="inline-flex">
      ...
      <input
        ref="root"
        type="file"
        class="absolute top-0 left-0 -z-1 h-full w-full cursor-pointer opacity-0 outline-none"
        :accept="accept"
        @input="upload"
      />
    </label>
    <div
      v-if="showFilename"
      class="rounded-r border border-gray-200 bg-gray-100 px-4 py-2 dark:border-slate-700 dark:bg-[#8D9D94]"
    >
